...
out = cv2.VideoWriter('/home/pramuk/Desktop/UAV-UGV/vayubhoomi-uav-ugv/catkin_ws/src/lidar/wasteTensorflow/video.mp4', fourcc, 20.0, (640, 480))
frameNumber = 0
...
def poseRecordCallback(location) :
    ...
    file = open('/home/pramuk/Desktop/UAV-UGV/vayubhoomi-uav-ugv/catkin_ws/src/lidar/src/positions.csv', 'a')
...
def imageCallback(ros_image):
    ...
    pos = rospy.Subscriber("/quadrotor/ground_truth_to_tf/pose", PoseStamped, poseRecordCallback)
...
def main(args):
    ...
    imageTopic = "/quadrotor/front_cam/camera/image"
